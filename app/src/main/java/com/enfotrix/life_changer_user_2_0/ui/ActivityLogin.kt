...
class ActivityLogin : AppCompatActivity() {
    ...
    private fun loginUser(pin:String,cnic: String){
                ...
                try {
                    ...
                    if(jsonObject!=null){
                        ...
                        if(jsonObject.getBoolean("success")==true){
                            ...
                            sharedPrefManager.putToken(data.getString("token"))
                            sharedPrefManager.setLogin(true)
                            sharedPrefManager.setLoginStatus(status)

                            if(status.equals(constants.INVESTOR_STATUS_ACTIVE)|| status.equals(constants.INVESTOR_STATUS_PENDING)) {
                            ...
                            else if (status.equals(constants.INVESTOR_STATUS_INCOMPLETE)){
                            ...
                            else Toast.makeText(mContext, "User Blocked By Admin", Toast.LENGTH_SHORT).show()
                ...
                try {
                    ...
                    if(jsonObject!=null){
                        ...
                        if(jsonObject.getBoolean("success")==true){
                            ...
                            binding.etCNIC.editText?.error = "CNIC Not Exist!"
